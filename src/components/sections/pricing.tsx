    ...
    <section id="pricing" className="relative isolate px-4 py-28 sm:px-8">
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-16">
        <SectionHeading
          ...
          title="Pay for exactly what you want."
          description="No confusing tiers. Choose a one-time build you own outright, or an ongoing growth partnership — that's it."
        />
    ...
    <TiltCard className="h-full">
      ...
      >
        ...
        <div className="flex items-end gap-2">
          <span className="font-[family-name:var(--font-mono)] text-4xl font-semibold tracking-tight sm:text-5xl">
            {plan.price}
          </span>
